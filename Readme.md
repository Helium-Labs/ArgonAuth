...
Self-custodial LSIG accessed through a users authenticator via a hijacked version of Webauthn.

## Monorepo Guide

Monorepo using Workspaces, with several examples of compatible build process. See [Monorepo Guide](./MonoRepoGuide.md).


## License

All rights reserved and copyrighted to owner Helium Labs. License can be changed at the discretion of Helium Labs.
