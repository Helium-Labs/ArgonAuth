...
import { CredentialCreateOptions } from '../models';
...
export const FidoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        fidoGetRound: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/getLastRound`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        fidoMakeCredentialOptions: async (body: MakeCredentialOptionsModel, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const FidoApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async fidoGetRound(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<number>>> {
            const localVarAxiosArgs = await FidoApiAxiosParamCreator(configuration).fidoGetRound(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async fidoMakeCredentialOptions(body: MakeCredentialOptionsModel, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<CredentialCreateOptions>>> {
            const localVarAxiosArgs = await FidoApiAxiosParamCreator(configuration).fidoMakeCredentialOptions(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const FidoApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async fidoGetRound(options?: AxiosRequestConfig): Promise<AxiosResponse<number>> {
            return FidoApiFp(configuration).fidoGetRound(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {MakeAssertionRequestModel} body 
         ...
         * @throws {RequiredError}
         */
        async fidoMakeCredentialOptions(body: MakeCredentialOptionsModel, options?: AxiosRequestConfig): Promise<AxiosResponse<CredentialCreateOptions>> {
            return FidoApiFp(configuration).fidoMakeCredentialOptions(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} body 
...
export class FidoApi extends BaseAPI {
     ...
     * @memberof FidoApi
     */
    public async fidoGetRound(options?: AxiosRequestConfig) : Promise<AxiosResponse<number>> {
        return FidoApiFp(this.configuration).fidoGetRound(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {MakeAssertionRequestModel} body 
     ...
     * @memberof FidoApi
     */
    public async fidoMakeCredentialOptions(body: MakeCredentialOptionsModel, options?: AxiosRequestConfig) : Promise<AxiosResponse<CredentialCreateOptions>> {
        return FidoApiFp(this.configuration).fidoMakeCredentialOptions(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} body 
